    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              `default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://accounts.google.com https://apis.google.com https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: ${trustedHostnames} https://*.googleusercontent.com https://res.cloudinary.com https://*.cloudinary.com; connect-src 'self' ${trustedHostnames} https://axile.ng https://nubapi.com https://accounts.google.com https://va.vercel-scripts.com https://vitals.vercel-insights.com; frame-src https://accounts.google.com;`,
          },
        ],
      },
    ];
