...
import { Twitter, Instagram, Linkedin, Music2, ChevronRight, MessageCircle } from 'lucide-react';
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: WhatsAppIcon, href: WHATSAPP_GROUP_LINK, label: 'WhatsApp', isWhatsApp: true },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-base max-w-xs leading-relaxed">
              ...
              tech-driven experience. Your Axile for the best events.
            </p>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-xs text-muted-foreground flex items-center gap-1">
            ...
            <span className="font-bold text-foreground">Axile</span>
