...
const PaystackTab = ({ summary, onPay }) => {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="bg-rose-500/5 border border-rose-500/10 rounded-2xl p-6 text-center">
        ...
        <h3 className="text-lg font-semibold mb-2">Automated Payment</h3>
        <p className="text-sm text-muted-foreground max-w-xs mx-auto">
          Secure, instant payment via Paystack. Your ticket will be confirmed immediately after payment.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <Button 
          onClick={onPay}
          className="w-full h-14 text-lg bg-rose-600 hover:bg-rose-700 shadow-rose-600/20 shadow-lg"
        >
