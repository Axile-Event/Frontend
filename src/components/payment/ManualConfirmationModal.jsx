...
const ManualConfirmationModal = ({
  ...
  const bookingId = propBookingId || storedBookingId;
        ...
        {bookingError ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <div className="space-y-6 max-h-[65vh] overflow-y-auto px-1 custom-scrollbar">
              ...
              <div className="space-y-2">
                <CustomDropdown
                  ...
                  onChange={(val) =>
                    setFormData({ ...formData, bankCode: val, accountName: "" })
                  }
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute left-5 top-1/2 -translate-y-1/2 text-lg font-bold text-gray-500 group-focus-within:text-rose-500 transition-colors">
                    ₦
                  </div>
                  <Input
                    id="amount"
              ...
              <div className="space-y-2">
                ...
                <label className="group relative block border-2 border-dashed border-white/5 rounded-3xl p-8 text-center hover:border-rose-500/30 hover:bg-rose-500/5 transition-all cursor-pointer bg-white/5 backdrop-blur-sm">
                  ...
                  />
                  <Upload
                    className="mx-auto text-gray-500 group-hover:text-rose-500 group-hover:scale-110 transition-all mb-3"
                    size={32}
                  />
            ...
            <div className="pt-8 space-y-4">
              <Button
                type="submit"
                className="w-full h-14 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl font-bold shadow-xl shadow-rose-600/20 group transition-all"
                disabled={loading}
              >
                {loading ? <Loader2 className="animate-spin mr-2" /> : null}
                <span>Submit Confirmation</span>
                {!loading && (
                  <CheckCircle2 className="ml-2 w-4 h-4 opacity-0 group-hover:opacity-100 translate-x-1 transition-all" />
                )}
              </Button>
              <p className="text-[10px] text-center text-gray-500 font-medium px-4">
                By submitting, you agree that providing false information may
                lead to permanent ticket cancellation and account suspension.
              </p>
            </div>
          </form>
        )}
