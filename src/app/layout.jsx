...
export const metadata = {
  ...
  creator: "Axile",
  publisher: "Axile",
  metadataBase: new URL(process.env.NEXT_PUBLIC_MAIN_APP_URL || 'https://app.axile.ng'),
  openGraph: {
    type: "website",
    locale: "en_NG",
    url: process.env.NEXT_PUBLIC_MAIN_APP_URL || "https://app.axile.ng",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              "name": "Axile",
              "url": process.env.NEXT_PUBLIC_LANDING_URL || "https://axile.ng",
