...
export const metadata = {
  title: {
    default: "Axilex - Modern Event Ticketing Platform",
    template: "%s | Axilex",
  },
  description: "Discover and book tickets for the hottest events. Axilex is your go-to platform for seamless event management and ticket purchasing.",
  keywords: ["events", "tickets", "event management", "ticket booking", "concerts", "festivals", "campus events"],
  authors: [{ name: "Axilex Team" }],
  creator: "Axilex",
  publisher: "Axilex",
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://Axilex-events.app'),
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "/",
    title: "Axilex - Modern Event Ticketing Platform",
    description: "Discover and book tickets for the hottest events. Axilex is your go-to platform for seamless event management and ticket purchasing.",
    siteName: "Axilex",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Axilex Event Ticketing Platform",
      },
    ],
  },
  twitter: {
